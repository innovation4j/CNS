...
echo /home/iot/anaconda3/bin/python "$homedir"/iot_detect_export.py $linenumber"_"$stb $today
/home/iot/anaconda3/bin/python "$homedir"/iot_detect_export.py $linenumber"_"$stb $today # comment : need parameters MB5 20210811
