...
def setValue(eqpt, id):
    #settingValue (xÃà½ÃÀÛÁÂÇ¥(mm), XÃà º¯È¯°ª(px->mm), YÃà º¯È¯°ª(px->mm), xÃà ¹üÀ§ÃÖ¼Ò°ª, xÃà ¹üÀ§ ÃÖ´ë°ª)
    value = (0, 0, 0, 0, 0)
    id = id%10
    if eqpt == "mb3":
        if id==1:
            value = (0, 0.31, 0.31, 0, 1920, 1330)
        if id==2:
            value = (600, 0.31, 0.31, 0, 1920, 1330)
        if id==3:
            value = (1200, 0.31, 0.31, 0, 1920, 1330)

        if id==4:
            value = (0, 0.23, 0.23, 0, 1920, 1280)
        if id==5:
            value = (450, 0.23, 0.23, 0, 1920, 1280)
        if id==6:
            value = (900, 0.23, 0.23, 0, 1920, 1280)  
        if id==7:
            value = (1350, 0.23, 0.23, 0, 1920, 1280)  
    else:
        if id==1:
            value = (0, 0.31, 0.31, 0, 1920, 1330)
        if id==2:
        ...
        if id==4:
            value = (100, 0.21, 0.21, 0, 1920, 1280)
        if id==5:
            value = (500, 0.21, 0.21, 0, 1920, 1280)
        if id==6:
            value = (900, 0.21, 0.21, 0, 1920, 1280)  
        if id==7:
            value = (1300, 0.21, 0.21, 0, 1920, 1280) 
    return value
